...
void test_validate_my_username()
{
     ...
     */
     TEST_ASSERT_EQUAL_CHAR_ARRAY_MESSAGE(my_username(),malloc_username_from_conf_file(),strlen(malloc_username_from_conf_file()),"FAIL: AESD students, please fix me!");
}
